...
namespace w01
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            Rectangle rect = new Rectangle(80, 80, 80, 40);
        ...
        {
            Random r = new Random();
            //Color c = Color.FromArgb(r.Next(0, 255), r.Next(0, 255), r.Next(0, 255), r.Next(0, 255));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            graphics.FillRectangle(new SolidBrush(Color.GreenYellow), rect3);
            result += $"합 영역: {rect3.ToString()}\n";

            rect3.Offset(10, 20);
            //graphics.FillRectangle(new SolidBrush(Color.LightPink), rect3);
            result += $"이동 영역: {rect3.ToString()}\n";

            rect3.Inflate(20, 20);
            //graphics.FillRectangle(new SolidBrush(Color.MistyRose), rect3);
            result += $"확장 영역: {rect3.ToString()}\n";
            MessageBox.Show(result, "RectangleMethod");
        }
